...
class Musics extends ActiveRecord {
    ...
    protected $primaryKey = "musics_id";
    public $fields_form = array("musics_id","musics_title", "musics_genre", "musics_address", "musics_image", "musics_signer");
...
musics_signer) VALUES (:musics_title,:musics_genre,:musics_address,:musics_image,:musics_signer)");
    ...
    public function updateToDB() {
        ...
        $stmt = $this->db_connect->prepare("UPDATE $this->table_name SET 
        musics_title = :musics_title, musics_genre = :musics_genre, 
        musics_address = :musics_address,  musics_image = :musics_image, 
        musics_signer = :musics_signer WHERE musics_id=:musics_id LIMIT 1");
